...
[![Build Status](https:/travis-ci.org/eHealthAfrica/angular-eha.image.directive.svg?branch=master)](https://magnum.travis-ci.com/eHealthAfrica/angular-eha.image)
...
Install with npm:
    ...
    npm install --save angular-eha.image

Or alternatively bower:

    bower install --save angular-eha.image
...
- *dist/angular-eha.image.directive.js*
- *dist/angular-eha.image.directive.min.js*
- *dist/angular-eha-back-button.template.js* *(default)*
- *dist/angular-eha-back-button.template.min.js*

Then simply add `eha.image.directive` and `eha.image.directive.templates` (if you want templates!) as a dependencies somewhere in your project that makes sense and you're good to go.

#### A note on wiredep

If you're using wiredep `dist/angular-eha.image.directive.template.js` will be injected by default. If you don't want that to happen you'll like want to employ something along the following lines in your `Gruntfile`:
...
wiredep: {
 ...
  options: {
    exclude: [
      'bower_components/angular-eha.image/dist/angular-eha.image.directive.templates.js'
    ]
  }
  ...
}
...
<html ng-app="backButtonExample">
  <head>
    ...
    <script src="bower_components/angular/angular-eha.image.directive.js"></script>
    <script>
...
git clone git@github.com:yourusername/angular-eha.image.directive.git
# change into project folder
cd angular-eha.image.directive
# Add the upstream as a remote
git remote add upstream  git@github.com:eHealthAfrica/angular-eha.image.directive.git
...
```
bower register angular-eha.image.directive https://github.com/eHealthAfrica/angular-eha.image.directivegit
```
## License
