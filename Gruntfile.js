module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    copy: {
      scripts: {
        ...
        rename: function(dest, src) {
          return dest + src.replace('scripts','angular-eha.image.directive');
        }
      }
    },
    concat: {
    ...
    uglify: {
      dist: {
        files: {
          'dist/angular-eha.image.directive.min.js': ['.tmp/scripts.js'],
          'dist/angular-eha.image.directive.templates.min.js': ['.tmp/scripts.templates.js']
        }
      }
    },
    html2js: {
      dist: {
        ...
        module: 'eha.image.directive.templates',
        options: {
