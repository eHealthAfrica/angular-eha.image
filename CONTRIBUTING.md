...
[GitHub issue tracker]: https://github.com/eHealthAfrica/angular-eha.image.directive/search?type=Issues
[reduced test case]: http://css-tricks.com/reduced-test-cases
[new issue]: https://github.com/eHealthAfrica/angular-eha.image.directive/issues/new
...
1. Clone and fork the project
    ...
    ```bash
    git clone eHealthAfrica/angular-eha.image.directive.git
...
[the repo]: https://github.com/eHealthAfrica/angular-eha.image.directive.git
